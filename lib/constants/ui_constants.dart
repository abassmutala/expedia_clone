...
class Corners {
  ...
  static Radius baseRadius = Radius.circular(Doubles.base);
...
class DateTimeFormats {
  static DateFormat dateFormat = DateFormat('EEE, MMM d');
  static DateFormat dayMonth = DateFormat('d MMM');
  static DateFormat weekday = DateFormat('EEE');
